...
//                                .requestMatchers(HttpMethod.POST,"/api/employee/register").permitAll()
//                                .requestMatchers(HttpMethod.POST,"/api/employees/**").hasRole(RoleType.ADMIN.name()).anyRequest().authenticated()
                );
